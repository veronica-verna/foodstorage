...
## data visualisation
The Shapefiles that include the transport Routes of all products are visualised using the package leaflet, a tool to create interactive maps.

A map that shows the actual driving distance from the suppliers to the FoodCoop was build.

- leaflet-maps
.. display curves on map and straight lines 
- ggplots
shiny-app !
